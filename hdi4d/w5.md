...
<tbody>
	...
	<tr>
		...
		<span class="fnt12"><strong>Joonsuk Park</strong> - Hongik University</span></td>
    </tr>
	<tr>
...
# Directions and Maps
Bus infomation including routes and maps - [metlink.org.nz](https://www.metlink.org.nz/)<br> 
Wellington Combined Taxis - [taxis.co.nz](http://www.taxis.co.nz)<br>
Green Cabs - [greencabs.co.nz](https://www.greencabs.co.nz)<br>
<br>**Note:** Bus routes go in both directions. When waiting for the bus, make sure you are on the right side of the road.
## Getting to Te Papa
...
### From Courtney Place
Catch the *20* (Highbury), **81** (Eastbourne), or **14** (Wilton) bus and get off at stop **5012** (Lambton Central). Walk along Lambton Quay and Woodward St. to get to the Terrace.<br>
